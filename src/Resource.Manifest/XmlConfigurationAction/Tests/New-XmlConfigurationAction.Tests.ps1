    ...
    InModuleScope Resource.Manifest {
        ...
        Context 'When configuration file exists' {
            ...
            It 'Returns a custom object with an insert action and attributes.' {
                ...
                $actualItem = New-XmlConfigurationAction -Path TestDrive:\one.config -Append /configuration -Name node -Attributes @{ a1 = 'v1' ; a2 = 'v2' } -PassThru
            ...
            It 'Returns a custom object with an update action.' {
                ...
                $actualItem = New-XmlConfigurationAction -Path TestDrive:\one.config -Update /configuration/node -Attributes @{ a1 = 'v1' ; a2 = 'v2' } -PassThru
        ...
        Context 'Creating XmlConfigurationActions must be done via the ScriptBlock passed to New-Manifest' {
            ...
            It 'Accumulates XmlConfigurationActions into the Manifest being built.' {
                ...
                $builtManifest = New-ResourceManifest -Type Application -Name 'BizTalk.Factory' -Build {
                    ...
                    New-XmlConfigurationAction -Path TestDrive:\one.config -Append /configuration -ElementName node -Attributes @{ a1 = 'v1' ; a2 = 'v2' }
                    New-XmlConfigurationAction -Path TestDrive:\one.config -Update /configuration/node -Attributes @{ a1 = 'v1' ; a2 = 'v2' }
                }
