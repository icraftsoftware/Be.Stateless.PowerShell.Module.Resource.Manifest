    ...
    InModuleScope Resource.Manifest {
        ...
        Context 'When configuration file does not exist' {
            ...
            It 'Throws a ParameterBindingValidationException.' {
                { New-XmlUnconfigurationAction -Delete -Path 'c:\web.config' -XPath /configuration } | Should -Throw -ExceptionType $ParameterBindingValidationExceptionType
            }
        }
        ...
        Context 'When configuration file exists' {
            ...
            It 'Returns a custom object with a delete action.' {
                ...
                $actualItem = New-XmlUnconfigurationAction -Delete -Path TestDrive:\one.config -XPath /configuration/node -PassThru
            ...
            It 'Returns a custom object with an insert action.' {
                ...
                $actualItem = New-XmlUnconfigurationAction -Insert -Path TestDrive:\one.config -XPath /configuration -ElementName node -PassThru
            ...
            It 'Returns a custom object with an insert action and attributes.' {
                ...
                $actualItem = New-XmlUnconfigurationAction -Insert -Path TestDrive:\one.config -XPath /configuration -ElementName node -Attributes @{ a1 = 'v1' ; a2 = 'v2' } -PassThru
            ...
            It 'Returns a custom object with an update action.' {
                ...
                $actualItem = New-XmlUnconfigurationAction -Update -Path TestDrive:\one.config -XPath /configuration/node -Attributes @{ a1 = 'v1' ; a2 = 'v2' } -PassThru
        ...
        Context 'Creating XmlUnconfigurationActions must be done via the ScriptBlock passed to New-Manifest' {
            ...
            It 'Accumulates XmlUnconfigurationActions into the Manifest being built.' {
                ...
                $builtManifest = New-ResourceManifest -Type Application -Name 'BizTalk.Factory' -Build {
                    New-XmlUnconfigurationAction -Delete -Path TestDrive:\one.config -XPath /configuration/node
                    New-XmlUnconfigurationAction -Insert -Path TestDrive:\one.config -XPath /configuration -ElementName node -Attributes @{ a1 = 'v1' ; a2 = 'v2' }
                    New-XmlUnconfigurationAction -Update -Path TestDrive:\one.config -XPath /configuration/node -Attributes @{ a1 = 'v1' ; a2 = 'v2' }
                }
